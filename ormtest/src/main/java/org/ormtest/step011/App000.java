package org.ormtest.step011;

import org.ormtest.step011.entity.UserEntity;
...
public class App000 {
    ...
    private void start() throws Exception {
        ...
        // 数据库连接地址
        String dbConnStr = "jdbc:mysql://192.168.163.100:3306/test?user=root&password=123456";
        // 创建数据库连接
        ...
        // t_user 数据表有 100 万条数据
        String sql = "select * from t_user limit 1000000";
        ...
        // 打印实例化花费时间
        System.out.println("实例化花费时间 = " + (t1 - t0) + "ms,总共有" + list.size());
    }
}
